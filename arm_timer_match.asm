...
;     output:
;GPIO pin used in MAT mode that gives the action/output once T0TC== T0MR0
...
;6.TxMCR->to control what happens to TC when T0TC == T0MR0 ie interrupt genrated, TC reset, TC,PC stopped
;	there r 4 match reg(MR0, MR1, MR2, MR4) controlled by TxMCR 	
